...
export const NAV_COMMANDS: NavCommandGroup[] = [
  ...
  },
  {
    heading: "Docs",
    items: [
      { id: "docs-index",        label: "Docs overview",         icon: FileCode2, href: "/docs",                keywords: ["docs", "documentation"] },
      { id: "docs-architecture", label: "Architecture",          icon: Layers,    href: "/docs/architecture",   keywords: ["four-layer", "primitives", "rebuild test"] },
      { id: "docs-protocol",     label: "Protocol",              icon: Network,   href: "/docs/protocol",       keywords: ["events", "indexer", "orders", "service"] },
      { id: "docs-contracts",    label: "Contracts",             icon: FileCode2, href: "/docs/contracts",      keywords: ["addresses", "marketplace", "factory", "starknet"] },
      { id: "docs-sdk",          label: "SDK",                   icon: Package,   href: "/docs/sdk",            keywords: ["@medialane/sdk", "typescript", "starknet"] },
      { id: "docs-api",          label: "API",                   icon: Terminal,  href: "/docs/api",            keywords: ["rest", "endpoints", "backend"] },
      { id: "docs-agents",       label: "Agents",                icon: Bot,       href: "/docs/agents",         keywords: ["ai", "agents", "automation"] },
      { id: "docs-developers",   label: "Developers",            icon: Code2,     href: "/docs/developers",     keywords: ["build", "integrate", "developer guide"] },
