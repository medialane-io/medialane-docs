...
export const CONTRACTS: ContractInfo[] = [
  ...
  },
  {
    ...
    name: "MIP IPCollection Registry v0.4.0 (ERC-721 Factory)",
    chain: "Starknet",
    address: "0x0558c9b6ea4d403df6d765fb77be55702c572f0a811f037c6c4209fe1e5aeef2",
    desc: "Immutable registry + factory for ERC-721 IP collections. Each create_collection() call deploys a dedicated immutable IPNft ERC-721 contract, assigns a sequential numeric collectionId, and emits CollectionCreated. Tokens carry permanent provenance (original creator + registration timestamp) and per-token EIP-2981 royalties (receiver = creator, set once at mint, immutable). On-chain version() == \"0.4.0\".",
  },
  {
    category: "Collections & Launchpad",
