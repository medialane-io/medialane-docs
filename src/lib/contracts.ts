...
export const CONTRACTS: ContractInfo[] = [
  ...
  },
  {
    ...
    desc: "Multi-edition trading venue for ERC-1155 assets. Same redesigned order protocol as Medialane721 (SNIP-12 domain version 4), keeping the single-amount order shape while preserving edition quantities, so a single listing can be filled by multiple buyers across transactions. On-chain EIP-2981 royalties, per-offerer counter, unsigned fulfillment, reentrancy-guarded settlement. Redeployed 2026-06-26 (core protocol redeploy; supersedes the 2026-05-31 venue).",
  },
  {
    category: "Marketplace",
    name: "NFTComments",
