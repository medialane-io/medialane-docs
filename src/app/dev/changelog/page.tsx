...
const CHANGES = [
  ...
  },
  {
    ...
    items: [
      ...
      "medialane-starknet launchpad service-card copy synced with medialane-io. External-link defaults: ERC-1155 create-collection now defaults to the creator's medialane.io profile (parity with ERC-721); ERC-1155 mint-asset defaults the external_url to the collection page rather than the unminted asset URL.",
      "medialane-docs migrated to the cmdk command palette navigation (matches medialane-io / medialane-starknet). About page wrapped in the shared page container; the dapp's stale /learn and /docs redirects now point to docs.medialane.io.",
