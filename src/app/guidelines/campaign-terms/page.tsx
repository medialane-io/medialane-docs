  ...
  return (
    <div className="space-y-10 max-w-3xl">
      ...
      <div className="space-y-7 text-sm">
        ...
        <section className="space-y-2">
          <h3 className="font-semibold text-base">Creator Fund</h3>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          <h3 className="font-semibold text-base">Not a Financial Product</h3>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            <Link href="/support" className="underline underline-offset-2 hover:text-foreground transition-colors">our support page</Link>{" "}
            or read the full{" "}
            <Link href="/dao/airdrop" className="underline underline-offset-2 hover:text-foreground transition-colors">Creator Fund documentation</Link>.
          </p>
        </section>
