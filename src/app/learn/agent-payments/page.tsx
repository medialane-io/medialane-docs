...
const WHO = [
  ...
  },
  {
    ...
    desc: "A wallet is the only identity needed. Any script, backend, or device that can sign a transaction can pay and use the platform, with no sign-up required.",
  },
];
  ...
  return (
    <div className="space-y-10">
      ...
      <Section title="Why it matters">
        <p>
          A human can fill in a signup form and type a card number. An autonomous agent
          shouldn&apos;t have to. It needs to pay the way it does everything else:
