      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            { icon: Users, title: "Global Liquidity", desc: "A tokenized IP asset can be listed on a marketplace accessible by anyone, anywhere, with no gallery representation or publisher deal required." },
            { icon: Coins, title: "Shared Editions", desc: "Multi-edition (ERC-1155) collections let many collectors own editions of the same work, broadening participation without a gallery or publisher." },
