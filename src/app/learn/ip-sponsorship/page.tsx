    ...
    <div className="space-y-10">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground text-lg leading-relaxed">
          ...
          a brand or backer pays to attach their name or support to your work — and it lets
      ...
      <div className="space-y-8">
          ...
          <div className="space-y-3">
            ...
            <div className="bento-cell px-4 py-3 space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                to the asset, not a person: if the asset changes hands before it&apos;s
        ...
        <Section title="Why No Escrow?">
          <p>
            ...
            transaction. This removes an entire class of custodial risk — there is no pool of
            locked funds for a bug or exploit to target.
          </p>
        </Section>
        ...
        <Section title="License Terms Are Declarative">
          <p>
            ...
            genuinely settled — real-world terms like usage rights or resale intent are
            declarative record, not a lock the contract can hold a wallet to.
          </p>
        </Section>
      </div>
    </div>
