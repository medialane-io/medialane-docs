        ...
        <li className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Connect your Starknet wallet at <Link href="https://portal.medialane.io/account" className="text-primary hover:underline">/account</Link> and create an API key from the portal dashboard. You need a minimum of 500 MDLN in your wallet to provision a key.
            </p>
          </div>
        </li>
        <li className="flex gap-4">
...
# -H "Authorization: Bearer ml_live_YOUR_KEY"`}</DocCodeBlock>
  ...
  "message": "Invalid or missing API key"
      ...
      <p className="text-muted-foreground mb-3 text-sm">
        ...
        <Link href="https://portal.medialane.io/account" className="text-primary hover:underline">account dashboard</Link>.
      ...
      <p className="text-muted-foreground text-sm mb-3">
        ...
        See the <Link href="https://portal.medialane.io/integrate" className="text-primary hover:underline">Integrate page</Link> for tier details.
      </p>
      <p className="text-muted-foreground text-sm">
