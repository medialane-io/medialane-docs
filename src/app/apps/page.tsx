...
const APPS = [
  ...
  },
  {
    ...
    description:
      "Developer portal for API and SDK access. Generate keys, explore interactive documentation, monitor usage, and integrate Medialane into your own products.",
    features: [
      "Generate and manage API keys",
      "Browse interactive REST API documentation",
      "Monitor usage, rate limits, and quotas",
      "Download SDK and integration guides",
      "Configure webhooks and event subscriptions",
    ],
    tags: ["API Keys", "SDK", "Developer Tools", "REST API", "Webhooks"],
    badge: "Beta",
